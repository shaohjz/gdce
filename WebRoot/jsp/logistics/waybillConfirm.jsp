								...
								<div class="col-md-10 column">
									...
									<div>
										<ul class="nav nav-tabs">
											<li id="tab1" class="active" onclick="myclick(1)"><a
												href="<%=context%>/logistics?forward=query&state=0&page=1">待确认</a></li>
											...
											<li id="tab1" onclick="myclick(3)"><a
												href="<%=context%>/logistics?forward=query&state=3&page=1">已完成</a></li>
										</ul>
									</div>
														...
														<tr style="height: 40px">
															...
															<td>
																...
																<button class="btn btn-primary btn-xs"
																	data-toggle="modal" data-target="#myModal">确认运单</button>
																	...
																	<div class="modal-dialog">
																		<div class="modal-content">
																			<div class="modal-header">
																				...
																				<h4 class="modal-title" id="myModalLabel">运单详情</h4>
																			</div>
																			...
																			<div class="modal-footer">
																				<a
																					href="<%=context %>/logistics?forward=changestate&state=0&
																Cstate=1&page=1&waybillId=${waybillInfo.waybillId}">
																				<button class="btn btn-primary btn-xs">确认运单</button>
																				</a>
																			</div>

																			<div class="modal-footer">
																				<a
																					href="<%=context%>/logistics?forward=query&state=0&page=1">
																					<button class="btn btn-primary btn-xs">取消确认</button>
																				</a>
																			</div>
									...
									<div class="pull-right" style="text-align: center" id="paging">
										<ul class="pagination">
											...
											<li><a
												href="<%=context%>/logistics?forward=query&state=0&page=${page-1>1?page-1:1}">&laquo;</a></li>
											<c:forEach begin="1" end="${totalPages}" varStatus="loop">
												<li><a
													href="<%=context%>/logistics?forward=query&state=0&page=${loop.index}">${loop.index}</a>
												</li>
											</c:forEach>
											<li><a
												href="<%=context%>/logistics?forward=query&state=0&page=${page+1<totalPages?page+1:totalPages}">&raquo;</a>
											</li>
										</ul>
									</div>

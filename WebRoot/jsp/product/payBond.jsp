				...
				<div class="row clearfix">
						...
						<div class="panel panel-default">
							...
							<div class="panel-body" align="center">
								<a href="<%=context%>/jsp/product/payBond.jsp" target="_self"><button
										...
										onClick="showReport1()">商品发布</button></a>
							</div>
							<div class="panel-body" align="center">
					...
					<div class="col-md-10 column">
						<p style="font-size: 30px; text-align: center">
							<font color=#2F2F4F>缴纳保证金</font>
						</p>
						<hr />
						<form action="" method="post" name="form1" id="form1"
							style="text-align: left; font-size: 24px">
							<h3 style="text-align: center; line-height: 100px">
								<font color=#4F2F4F>发布商品前需先缴纳保证金，确认缴纳保证金吗？ <br />
									<button type="button" value="确认" class="mystyle"
										onclick="window.location.href='insertProduct.jsp'">确认</button>
									<button type="button" value="返回" class="mystyle"
										onclick="window.location.href = 'mumberCenter.jsp'">返回</button>
					</div>
				</div>
			</div>
		</div>

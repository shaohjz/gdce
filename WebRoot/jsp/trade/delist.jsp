	...
	<div class="main">
		...
		<div class="leftbotton">
			...
			<script type="text/javascript">
				...
				if (productstate == 0) 
				{
					document.write("<button type='button' class='btn btn-lg btn-primary' onclick=jump()>确认摘牌</button>");
				} else if (productstate == 1) 
				{
					document.write("<button type='button' class='btn btn-lg btn-primary' disabled='disabled'>确认摘牌</button>");
					document.write("<span style='vertical-align:bottom; color:red'>&nbsp;&nbsp;已有人摘牌</span>");
				} else 
				{
					document.write("<button type='button' class='btn btn-lg btn-primary' disabled='disabled'>确认摘牌</button>");
					document.write("<span style='vertical-align:bottom; color:red'>&nbsp;&nbsp;有人正在摘牌</span>");
				}
			</script>
		</div>
		<div class="rightbotton">
			<button type="button" class="btn btn-lg btn-primary"
				onclick="window.location.href ='<%=context%>/index.jsp'">返回</button>
		</div>
		<br> <br>
	</div>

					...
					<div class="col-md-10 column">
						<div
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a
									href="<%=context%>/jsp/contract/bothSigned.jsp">历史合同</a></li>
							</ul>
						</div>
						<%
						...
						%>
						<%
							if (contract.isBuyerContractState() == true && contract.isSellerContractState() == true) {
									count++;
						%>
						<div
							...
							<div style="padding-left: 20px">
								...
								<p style="text-align: right">买方合同状态： 买方已签
									&nbsp;&nbsp;&nbsp;&nbsp; 卖方合同状态：卖方已签 &nbsp;&nbsp;&nbsp;&nbsp;</p>
							</div>
						</div>
						<%
						...
						<%
							if (count == 0) {
						%>
						<div style="height: 300px;padding-left:50px">暂无历史合同</div>
						<%
							}
						%>

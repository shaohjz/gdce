					...
					<div class="col-md-10 column">
						<div
							...
							<ul class="nav nav-tabs">
								<li class="active"><a
									href="<%=context%>/jsp/contract/contractEnsure.jsp">买方未签订</a></li>
								<li><a href="<%=context%>/jsp/contract/SellerUnsigned.jsp">卖方未签订</a></li>
								<li><a href="<%=context%>/jsp/contract/bothSigned.jsp">历史合同</a></li>
							</ul>
						</div>
						<form id="myForm"
							action="<%=context%>/contract?forward=ensurelist" method="post"
							...
							%>
							<%
								if (contract.isBuyerContractState() == false) {
										count++;
							%>
							<div
								...
								<div style="padding-left: 20px">
									...
									<p style="text-align: right">
										...
										<%
											if (request.getSession().getAttribute("companyID").equals(contract.getBuyerCompanyId()))
													{
										%>
						...
						<%
							...
							{
						%>
						<div style="height: 300px; padding-left: 50px">暂无买方未签定的合同</div>
						<%
							}
						%>
